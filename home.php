...
<table width="80%" height="100%" border="0" bordercolor="#CCCCCC" cellpadding="0" cellspacing="0" align="left">
  ...
  <tr>
	...
	<span><?php echo "<img src='User_Data/$user/$img' height='119px'/>";?></span>
	    <span style="margin-left:45%"><a href="home.php?option=edit">Edit_Profile</a>
	<a href="home.php?option=pass">Change Key</a>
	<a href="home.php?option=theme">Customize MailDrop</a>	
	</span>
  ...
  <tr>
    <td colspan="2" align="center">Developed By Nehul Yadav</td>
  </tr>
  </form>
</table>
</body>
